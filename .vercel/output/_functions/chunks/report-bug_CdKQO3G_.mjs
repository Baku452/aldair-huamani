import { n as createInvalidVariablesError, o as getEnv$1, p as setOnSetGetEnv } from './entrypoint_DBJIxkIK.mjs';
...
const schema = {"GITHUB_TOKEN":{"context":"server","access":"secret","type":"string"}};
